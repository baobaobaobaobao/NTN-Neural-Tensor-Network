...
def data_to_indexed(data, entities, relations):
    ...
    #[(9536, 0, 37042), (37041, 1, 19056),..., (36330, 1, 2343)]#
    return indexed_data

def get_batch(batch_size, data, num_entities, corrupt_size):
    random_indices = random.sample(range(len(data)), batch_size)  #return random batch_size data
...
def run_training():
    ...
    # print(init_word_embeds[1])
    # a = []
    # for item in entity_to_wordvec:
    #     a = a+item
    #     a = list(set(a))
    #     #print(a)
    #     #print(len(a))
    ...
    # relation_batches = sess.graph.get_operations('relation_batches')
